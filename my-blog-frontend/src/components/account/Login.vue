...
function userLogin() {
  formRef.value.validate((isValid) => {
    if(isValid) {
      login(formDetails.username, formDetails.password, formDetails.isRememberMe, () => router.push("/"))
    }else{
